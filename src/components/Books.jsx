...
const Books = () => {
  ...
  const bookReviews = [
    ...
    { month: "August", year: 2023, book: "Crying in H Mart", author: "", review: "" },
    ...
    { month: "March", year: 2023, book: "The Unspoken Rules: Secrets to Starting Your Career Off Right", author: "", review: "" },
